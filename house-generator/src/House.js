...
*/
    ...
    calculateApartmentSizes() {
        ...
        console.log("Min apartment size:" + this.minApartmentSize + " Max apartment size: " + this.maxApartmentSize);
        console.log("Mean apartmenz size: " + meanApartmentSize)
        console.log(" Min negative difference between Mean and Min apartment size:" + (-diffToMinApartmentSize));
        console.log("Max positive difference between Mean and Max apartment size: " + diffToMaxApartmentSize);
        ...
        var randomAreaDifference = Math.random() * (diffToMaxApartmentSize - (-diffToMinApartmentSize)) + (-diffToMinApartmentSize);
        var variationSum = 0;
        ...
        for (var i = 0; i < this.apartmentCount - 1; i++) {
            ...
            randomAreaDifference = Math.random() * (diffToMaxApartmentSize - (-diffToMinApartmentSize)) + (-diffToMinApartmentSize);
    ...
    squarifiedTreeMap(apartmentSizes) {
        ...
        while (apartmentSizeList.length > 0) {
            ...
            let currentHeight = Tools.getInstance().distanceBetweenTwoVertices(leftWall.a, leftWall.b);
            let currentWidth = Tools.getInstance().distanceBetweenTwoVertices(lowerWall.a, lowerWall.b);
            let currentRow = []
            ...
            if (currentWidth > currentHeight) {
                ...
                while (apartmentSizeList.length > 0) {
                    console.log(">>>>>>>>>>>>>>>New Iteration of trying to add preApartments to left wall row")
                    ...
                    if (currentRow.length == 0) {
                        ...
                        currentRow.push(new PreApartment(firstApartmentArea, null, currentHeight))
                    ...
                    let currentRowWorstAspectRatio = Math.max(...currentRow.map(preApartment => preApartment.aspectRatio))
                    ...
                    let nextRow = currentRow.map(
                        preAp => new PreApartment(preAp._area, preAp._width, preAp._height)
                    );
                    ...
                    let nextPreApartment = new PreApartment(apartmentSizeList[0], nextRowWidth, null);
                    ...
                    let nextRowWorstAspectRatio = Math.max(...nextRow.map(preApartment => preApartment.aspectRatio))
                    console.log("Test: nextRow worst aspect Ratio", nextRowWorstAspectRatio, "vs currentRow worst aspect Ratio", currentRowWorstAspectRatio);
                    ...
                    if (currentRowWorstAspectRatio > nextRowWorstAspectRatio) {
                        ...
                        for (let preAp of currentRow) {
                            ...
                            let newApartment = new Apartment(preAp.area, apColor, preAp.width, preAp.height, newApX, newApY);
                ...
                while (apartmentSizeList.length > 0) {
                    ...
                    if (currentRow.length == 0) {
                        ...
                        // TODO: Schauen, ob sich die currentHeight im Verlauf irgendwie verändert und das dann ne DeepCopy ist, die auch das preAp verändert ... ?
                        let firstPreAp = new PreApartment(firstApartmentArea, currentWidth, null)
                    ...
                    // Create possible next apartment 
                    let nextPreApartment = new PreApartment(apartmentSizeList[0], null, nextRowHeight);
                    ...
                    if (currentRowWorstAspectRatio > nextRowWorstAspectRatio) {
                        ...
                        console.log("vvvvvvvvvvvvvvvvvvv END of iteration of trying to add preApartments to lower wall row")
                        // return;
                        break;
                    }
    ...
    calculateFloorPlan() {
        ...
        let roomBlockAreaSum = leftWallRooms.reduce((areasum, apartment) => areasum + apartment.area, 0);
        ...
        console.log("roomblockwidth: ", roomBlockWidth, "wall length: ", placementWallLength, " roomblock area sum redone: ", (roomBlockWidth * placementWallLength));
