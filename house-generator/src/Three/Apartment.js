...
class Apartment {
    ...
    constructor(apartmentSize, materialColor, width, height, posX, posY) {
        ...
        this._material = new THREE.MeshStandardMaterial({ color: materialColor, side: THREE.DoubleSide });  //side: THREE.DoubleSide, 
        this._width = width;
        this._height = height;
    ...
    calculateVertices() {
        ...
        let a = this._vertices.a = new Vector2(this._position.x - this._width / 2, this._position.y - this._height / 2);
        let b = this._vertices.b = new Vector2(this._position.x + this._width / 2, this._position.y - this._height / 2);
        let c = this._vertices.c = new Vector2(this._position.x + this._width / 2, this._position.y + this._height / 2);
        let d = this._vertices.d = new Vector2(this._position.x - this._width / 2, this._position.y + this._height / 2);
    ...
    setVertices(newVertices) {
        ...
        this._aspectRatio = Math.max((this._width / this._height), (this._height / this._width));
    }
    ...
    logApartment() {
        ...
        console.log("set area:", this._apartmentArea, "set width", this._width, "set height ", this._height)
